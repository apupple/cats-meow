...
INSERT INTO person VALUES
  (1, 'Light', 'Yagami', 'light.yagami@gmail.com', '02/28/2004', 'Street 1', 'San Antonio', 'TX', 78249)
  (2, 'Gojo', 'Satoru', 'imGojo@gmail.com', '12/07/2001', 'Street 2', 'San Antonio', 'TX', 78249)
  (3, 'Tanjiro', 'Kamado', 'tanjiro.kamado@gmail.com', '03/18/2008', 'Street 3', 'San Antonio', 'TX', 78249)
  (4, 'Langa', 'Hasegawa', 'langa.hasegawa@gmail.com', '07/12/2007', 'Street 4', 'San Antonio', 'TX', 78249)
  (5, 'Nancy', 'Wheeler', 'notNancyDrew@gmail.com', '08/27/1999', 'Street 5', 'San Antonio', 'TX', 78249)
  (6, 'Will', 'Byers', 'will.byers123@gmail.com', '06/15/2007', 'Street 6', 'San Antonio', 'TX', 78249)
...
-- 4) ENCLOSURE (enclosure_id, enclosure_sanitation_status, enclosure_max_capacity, enclosure_current_capacity) --
...
-- 17) SURGERIES (surgery_id, medical_history_id, surgery_name, surgery_desc, surgery_date,	surgery_start_time,	surgery_end_time) --
INSERT INTO surgeries VALUES
  (1, 1, 'SPAY', 'Routine ovariohysterectomy performed without complications', '05/12/24', '09:00:00', '09:35:00')
  (2, 2, 'NEUTER', 'Routine orchiectomy performed without complications', '10/03/23', '10:30:00', '11:00:00')
  (1, 4, 'SPAY', 'Routine ovariohysterectomy performed without complications', '08/14/24', '09:00:00', '09:55:00')
