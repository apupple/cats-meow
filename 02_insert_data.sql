...
-- Enclosures 1 & 2 = cats (young/old), 3 & 4 = dogs (young/old), 5 & 6 = birds (young/old), 7 & 8 = small fish (young/old), 9 & 10 = hamsters (young/old), 11 & 12 = rabbits
-- Enclosures 13 & 14 = exotic animals (young/old), 15 & 16 = reptiles (young/old), 17 & 18 = quarantined birds (young/old), 19 & 20 = aquatic quarantied animals (young/old), 21 & 22 = amphibians (young/old) , 23 & 24 = quarantined animals
...
-- Core (1–24 covers all enclosures)
(1,1,1,1,'Bella',2,'F','playful kitten'),
(2,5,2,2,'Shadow',6,'M','calm older cat'),
(3,3,3,3,'Turbo',1,'M','energetic puppy'),
(4,4,4,4,'Goldie',5,'F','friendly retriever'),
(5,17,5,5,'Sky',1,'F','blue parakeet'),
(6,18,6,6,'Sunny',4,'M','yellow cockatiel'),
(7,19,7,7,'Bubbles',1,'M','goldfish'),
(8,20,8,8,'Flash',2,'F','betta fish'),
(9,21,9,9,'Nibbles',1,'F','tiny hamster'),
(10,22,10,10,'Peanut',2,'M','dwarf hamster'),
(11,23,11,11,'Hopper',2,'M','lop rabbit'),
(12,24,12,12,'Clover',3,'F','white rabbit'),
(13,25,13,13,'Slinky',2,'M','ferret'),
(14,26,14,14,'Spike',3,'F','hedgehog'),
(15,27,15,15,'Leo',1,'M','gecko'),
(16,28,16,16,'Shadow',4,'F','python'),
(17,29,17,17,'Rio',2,'M','recovering macaw'),
(18,18,18,18,'Chirpy',5,'F','sick cockatiel'),
(19,30,19,19,'Angel',3,'F','angelfish'),
(20,20,20,20,'Blaze',2,'M','healing betta'),
(21,31,21,21,'Sprout',1,'F','tree frog'),
(22,32,22,22,'Axie',2,'M','axolotl'),
(23,3,23,23,'Buddy',2,'M','dog under watch'),
(24,5,24,24,'Lily',3,'F','cat in recovery'),
(25,17,5,1,'Blue',2,'M','quiet parakeet'),
(26,29,6,2,'Scarlet',3,'F','loud macaw'),
(27,18,5,3,'Pico',1,'M','tiny bird'),
(28,29,6,4,'Flare',6,'M','large macaw'),
(29,19,7,5,'Goldy',1,'F','round goldfish'),
(30,30,8,6,'Fin',2,'M','silver angelfish'),
(31,20,7,7,'Wave',3,'F','blue betta'),
(32,30,8,8,'Drift',4,'M','calm angelfish'),
(33,21,9,9,'Cheeks',1,'M','small hamster'),
(34,22,10,10,'Dusty',2,'F','gray hamster'),
(35,21,9,11,'Popcorn',1,'F','energetic hamster'),
(36,22,10,12,'Snow',3,'M','white hamster'),
(37,23,11,13,'Thumper',2,'F','active rabbit'),
(38,24,12,14,'Bunbun',4,'M','calm rabbit'),
(39,23,11,15,'Carrot',1,'M','playful rabbit'),
(40,24,12,16,'Fluff',5,'F','long fur rabbit'),
(41,25,13,17,'Dash',1,'M','quick ferret'),
(42,26,14,18,'Needle',3,'F','curious hedgehog'),
(43,25,13,19,'Zippy',2,'F','energetic ferret'),
(44,26,14,20,'Cactus',4,'M','quiet hedgehog'),
(45,27,15,21,'Spot',2,'F','patterned gecko'),
(46,28,16,22,'Viper',5,'M','large snake'),
(47,27,15,23,'Pebble',1,'M','small gecko'),
(48,28,16,24,'Onyx',6,'F','dark python'),
(49,31,21,1,'Leaf',1,'M','tiny frog'),
(50,32,22,2,'Pinky',3,'F','bright axolotl'),
(51,31,21,3,'Moss',2,'F','green frog'),
(52,32,22,4,'Glow',2, 'M','soft axolotl'),
(53,11,3,5,'Rocky',3,'M','lab mix'),
(54,1,1,6,'Milo',2,'M','playful kitten');
...
INSERT INTO adopter VALUES
  ...
  (3, 10, 3, 'house with fenced yard', TRUE, '6 hours M-F'),
  (4, 15, 4, 'apartment, lives alone', FALSE, '9 hours M-F'),
  (5, 21, 5, 'townhouse with partner', TRUE, '8 hours M-F'),
  (6, 30, 6, 'house with 2 kids', TRUE, '5 hours M-F'),
  (7, 41, 7, 'apartment with roommate', FALSE, '10 hours M-F'),
  (8, 50, 8, 'house with backyard', TRUE, '7 hours M-F'),
  (9, 12, 9, 'condo, no yard', FALSE, '8 hours M-F'),
  (10, 18, 10, 'house with fenced yard', TRUE, '6 hours M-F'),
  (11, 25, 11, 'apartment, pet-friendly', TRUE, '9 hours M-F'),
  (12, 33, 12, 'house with large yard', TRUE, '4 hours M-F'),
  (13, 45, 13, 'apartment with partner', FALSE, '8 hours M-F'),
  (14, 52, 14, 'house with family', TRUE, '6 hours M-F'),
  (15, 60, 15, 'townhome, quiet area', TRUE, '7 hours M-F'),
  (16, 8, 16, 'apartment with siblings', FALSE, '8 hours M-F'),
  (17, 14, 17, 'house with yard', TRUE, '5 hours M-F'),
  (18, 19, 18, 'condo downtown', FALSE, '9 hours M-F'),
  (19, 27, 19, 'house with pets already', TRUE, '6 hours M-F'),
  (20, 36, 20, 'large estate home', TRUE, '4 hours M-F'),
  (21, 48, 21, 'apartment, quiet', TRUE, '8 hours M-F'),
  (22, 55, 22, 'house near park', TRUE, '7 hours M-F'),
  (23, 63, 23, 'townhouse', FALSE, '9 hours M-F'),
  (24, 70, 24, 'house with big yard', TRUE, '5 hours M-F');
...
INSERT INTO employee VALUES
  ...
  (2, 2, 2, 'M-F full', 'animal care', TRUE,'MANAGER', 'EMPLOYED', 18.5, '2022-07-23', NULL),
  (3, 3, 3, 'M-F mornings', 'animal care', TRUE, 'TECH', 'EMPLOYED', 15.0, '2023-01-10', NULL),
  (4, 5, 4, 'Weekends only', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.5, '2023-03-12', NULL),
  (5, 7, 5, 'Evenings M-F', 'medical', TRUE, 'TECH', 'EMPLOYED', 16.0, '2023-05-01', NULL),
  (6, 9, 6, 'M-F full day', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.0, '2023-06-15', NULL),
  (7, 11, 7, 'Weekends + evenings', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.0, '2023-08-01', NULL),
  (8, 13, 8, 'M-F mornings', 'medical', TRUE, 'TECH', 'EMPLOYED', 17.0, '2023-09-10', NULL),
  (9, 16, 9, 'M-F full day', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.5, '2023-10-05', NULL),
  (10, 20, 10, 'Weekends', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.5, '2023-11-11', NULL),
  (11, 21, 11, 'M-F evenings', 'medical', TRUE, 'TECH', 'EMPLOYED', 16.5, '2024-01-01', NULL),
  (12, 24, 12, 'M-F mornings', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.0, '2024-02-02', NULL),
  (13, 28, 13, 'Full-time', 'adoption', TRUE, 'COORDINATOR', 'EMPLOYED', 17.5, '2024-03-03', NULL),
  (14, 31, 14, 'Evenings + weekends', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.5, '2024-04-04', NULL),
  (15, 34, 15, 'M-F full day', 'medical', TRUE, 'TECH', 'EMPLOYED', 18.0, '2024-05-05', NULL),
  (16, 38, 16, 'Weekends only', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.0, '2024-06-06', NULL),
  (17, 40, 17, 'M-F mornings', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.0, '2024-07-07', NULL),
  (18, 42, 18, 'Full-time', 'management', TRUE, 'SUPERVISOR', 'EMPLOYED', 20.0, '2024-08-08', NULL),
  (19, 46, 19, 'Evenings', 'medical', TRUE, 'TECH', 'EMPLOYED', 17.0, '2024-09-09', NULL),
  (20, 49, 20, 'M-F full day', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.5, '2024-10-10', NULL),
  (21, 53, 21, 'Weekends', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.5, '2024-11-11', NULL),
  (22, 58, 22, 'Full-time', 'medical', TRUE, 'TECH', 'EMPLOYED', 18.5, '2024-12-12', NULL),
  (23, 65, 23, 'M-F mornings', 'animal care', TRUE, 'CARETAKER', 'EMPLOYED', 14.0, '2025-01-01', NULL),
  (24, 72, 24, 'Evenings + weekends', 'adoption', TRUE, 'ASSISTANT', 'EMPLOYED', 13.5, '2025-02-02', NULL);
...
INSERT INTO volunteer VALUES
  (1, 3, 1, 'MWF 1-6', TRUE, TRUE, 10, 'ACTIVE', '2025-12-03', NULL),
  (2, 5, 2, 'TTh 9-5', FALSE, TRUE, 0, 'INACTIVE', NULL, NULL),
  (3, 6, 3, 'Weekends', TRUE, TRUE, 15, 'ACTIVE', '2025-01-01', NULL),
  (4, 7, 4, 'MWF mornings', TRUE, TRUE, 20, 'ACTIVE', '2025-01-10', NULL),
  (5, 9, 5, 'TTh afternoons', TRUE, TRUE, 12, 'ACTIVE', '2025-02-01', NULL),
  (6, 10, 6, 'Weekends', TRUE, TRUE, 5, 'ACTIVE', '2025-02-15', NULL),
  (7, 12, 7, 'MWF evenings', TRUE, TRUE, 18, 'ACTIVE', '2025-03-01', NULL),
  (8, 14, 8, 'TTh mornings', TRUE, TRUE, 22, 'ACTIVE', '2025-03-10', NULL),
  (9, 16, 9, 'Weekends', TRUE, TRUE, 30, 'ACTIVE', '2025-04-01', NULL),
  (10, 18, 10, 'MWF afternoons', TRUE, TRUE, 16, 'ACTIVE', '2025-04-15', NULL),
  (11, 21, 11, 'TTh evenings', FALSE, TRUE, 8, 'INACTIVE', '2025-05-01', NULL),
  (12, 24, 12, 'Weekends', TRUE, TRUE, 25, 'ACTIVE', '2025-05-10', NULL),
  (13, 27, 13, 'MWF mornings', TRUE, TRUE, 14, 'ACTIVE', '2025-06-01', NULL),
  (14, 30, 14, 'TTh afternoons', TRUE, TRUE, 19, 'ACTIVE', '2025-06-10', NULL),
  (15, 33, 15, 'Weekends', TRUE, TRUE, 21, 'ACTIVE', '2025-07-01', NULL),
  (16, 36, 16, 'MWF evenings', FALSE, TRUE, 6, 'INACTIVE', '2025-07-10', NULL),
  (17, 41, 17, 'TTh mornings', TRUE, TRUE, 17, 'ACTIVE', '2025-08-01', NULL),
  (18, 45, 18, 'Weekends', TRUE, TRUE, 28, 'ACTIVE', '2025-08-15', NULL),
  (19, 50, 19, 'MWF afternoons', TRUE, TRUE, 13, 'ACTIVE', '2025-09-01', NULL),
  (20, 55, 20, 'TTh evenings', TRUE, TRUE, 11, 'ACTIVE', '2025-09-10', NULL),
  (21, 60, 21, 'Weekends', TRUE, TRUE, 24, 'ACTIVE', '2025-10-01', NULL),
  (22, 63, 22, 'MWF mornings', TRUE, TRUE, 15, 'ACTIVE', '2025-10-10', NULL),
  (23, 66, 23, 'TTh afternoons', FALSE, TRUE, 7, 'INACTIVE', '2025-11-01', NULL),
  (24, 71, 24, 'Weekends', TRUE, TRUE, 26, 'ACTIVE', '2025-11-10', NULL);
...
INSERT INTO enclosure_type VALUES
  (1, 1, 'Indoor feline enclosure for young cats with multi-level climbing shelves - cozy bedding - and enrichment toys for small to medium-sized kittens'),
  (2, 2, 'Indoor feline enclosure for senior cats with low-access bedding - calm environment - and gentle enrichment toys for older small to medium-sized cats'),
  (3, 3, 'Indoor canine enclosure for young dogs with spacious kennel runs - padded flooring - and active play area suitable for puppies and small to large breed dogs'),
  (4, 4, 'Indoor canine enclosure for senior dogs with spacious kennel runs - orthopedic padded flooring - and low-impact play area suitable for older small to large breed dogs');
